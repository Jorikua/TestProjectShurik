...
public class TestProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "ru.vsevolodkaganovych.testprojectshurik.provider";
    ...
    private static final int URI_TYPE_TEST_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, TestColumns.TABLE_NAME, URI_TYPE_TEST);
        URI_MATCHER.addURI(AUTHORITY, TestColumns.TABLE_NAME + "/#", URI_TYPE_TEST_ID);
    }

    protected TestSQLiteOpenHelper mTestSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mTestSQLiteOpenHelper = TestSQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_TEST:
                return TYPE_CURSOR_DIR + TestColumns.TABLE_NAME;
            case URI_TYPE_TEST_ID:
                return TYPE_CURSOR_ITEM + TestColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mTestSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mTestSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mTestSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mTestSQLiteOpenHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_TEST:
            case URI_TYPE_TEST_ID:
                res.table = TestColumns.TABLE_NAME;
                res.tablesWithJoins = TestColumns.TABLE_NAME;
                res.orderBy = TestColumns.DEFAULT_ORDER;
                break;
